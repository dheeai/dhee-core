...
// npm-ecosystem discovery entry (dhee.runners): an array of
// { manifest, runner } pairs, consumed by ecosystem.ts/discoverNpmRunners.
// (The single `runner` + runner.json above serve the sideload path.)
