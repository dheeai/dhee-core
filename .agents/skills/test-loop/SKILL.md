...
This skill exists so future Codex doesn't reinvent the test patterns
...
testing loop lives in dhee-desktop (`.Codex/skills/test-loop/`
...
- **Test by grep'ing source files.** Per AGENTS.md: "Never write
