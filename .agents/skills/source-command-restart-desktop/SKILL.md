---
name: "source-command-restart-desktop"
...
# source-command-restart-desktop

Use this skill when the user asks to run the migrated source command `restart-desktop`.
...
and Codex's Chrome-DevTools MCP tools can attach and drive the
