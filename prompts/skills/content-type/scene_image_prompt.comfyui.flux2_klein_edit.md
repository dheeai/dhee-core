...
So just name the entities in your prose directly — Sarah Chen, the Manor Library, the silver revolver. The downstream pipeline handles all slot binding.
...
- "A close-up of Sarah Chen, her expression thoughtful as she gazes out the window"
- "Marcus and Sarah sit across from each other at a table in the manor library"
- "A wide shot showing Sarah walking toward the front entrance"
...
- "the blurred interior of the manor visible in the background"
